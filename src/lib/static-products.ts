...
export const staticProducts: StaticProduct[] = [
  ...
  },
  {
    ...
    category: 'Hoodies',
    price: 50,
    image: '/products/hoodie-vinotinto-v2.webp',
    images: [
      '/products/hoodie-vinotinto-v2.webp',
      '/products/hoodie-vinotinto-2-v2.webp',
      '/products/hoodie-negro-v2.webp',
      '/products/hoodie-negro-2-v2.webp',
      '/products/hoodie-marron-v2.webp',
      '/products/hoodie-marron-2-v2.webp',
      '/products/hoodie-blanco-v2.webp',
      '/products/hoodie-blanco-2-v2.webp',
    ],
    colorImages: {
      'Vinotinto': [
        '/products/hoodie-vinotinto-v2.webp',
