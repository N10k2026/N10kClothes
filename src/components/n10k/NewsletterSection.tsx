  ...
  return (
    <section id="newsletter" className="py-5 sm:py-24 md:py-32 px-4 relative overflow-hidden bg-[#000000] n10k-pattern-bg">
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute top-[5%] left-0 w-full">
          ...
          >
            {[...Array(8)].map((_, i) => (
              <span
                key={`r1-${i}`}
                className="font-montserrat-black text-[12vw] sm:text-[10vw] md:text-[8vw] uppercase tracking-[0.08em] text-[#E30613]/[0.06] blur-[2px] px-4 select-none"
              >
                N10K
              </span>
            ))}
        ...
        <div className="absolute top-[30%] left-0 w-full">
          ...
          >
            {[...Array(6)].map((_, i) => (
              <span
                key={`r2-${i}`}
                className="font-montserrat-black text-[14vw] sm:text-[12vw] md:text-[10vw] uppercase tracking-[0.05em] text-[#E30613]/[0.05] blur-[3px] px-6 select-none"
              >
                CABALLERO
              </span>
            ))}
        ...
        {/* Row 3 - scrolling right, slower (hidden on mobile) */}
        <div className="absolute top-[60%] left-0 w-full hidden sm:block">
          ...
          >
            {[...Array(8)].map((_, i) => (
              <span
                key={`r3-${i}`}
                className="font-montserrat-black text-[11vw] sm:text-[9vw] md:text-[7vw] uppercase tracking-[0.1em] text-[#E30613]/[0.04] blur-[2px] px-4 select-none"
              >
                NUTRITION10K
              </span>
            ))}
        ...
        {/* Row 4 - scrolling left, very slow (hidden on mobile) */}
        <div className="absolute top-[85%] left-0 w-full hidden sm:block">
          ...
          >
            {[...Array(10)].map((_, i) => (
              <span
                key={`r4-${i}`}
                className="font-montserrat-black text-[8vw] sm:text-[7vw] md:text-[5vw] uppercase tracking-[0.12em] text-[#E30613]/[0.04] blur-[1px] px-3 select-none"
              >
                N10K ✦
              </span>
            ))}
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        <div ref={cardRef} className="glass-card-pro p-4 sm:p-10 md:p-12">
          ...
          <BlurFadeUp delay={0.3} duration={0.8} translateY={20} threshold={0.1}>
            <p className="text-gray-400 text-[11px] sm:text-base md:text-lg mb-3 sm:mb-8 leading-relaxed font-montserrat-medium break-words">
              Síguenos en Instagram y conversemos por WhatsApp. Forma parte de la comunidad N10K.
            </p>
          </BlurFadeUp>

          <BlurFadeUp delay={0.4} duration={0.8} translateY={20} threshold={0.1}>
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 max-w-md mx-auto">
              ...
              >
                <a
                  href="https://wa.me/584122880228?text=Hola%20N10K%2C%20quiero%20información%20sobre%20sus%20productos"
                  target="_blank"
                  rel="noopener noreferrer"
                >
